...
(function() {
  ...
  script.async = true;
  script.src = 'https://www.googletagmanager.com/gtag/js?id=G-G9Y694MPHD';
  document.head.appendChild(script);

  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-G9Y694MPHD');
})();
    ...
    <div class="footer-inner">\
      ...
      <div class="footer-top">\
        ...
        <div class="footer-col">\
          ...
          <p style="font-size:0.72rem;font-weight:700;color:#c0d8c0;text-transform:uppercase;letter-spacing:0.08em;margin:14px 0 6px;">US Office</p>\
          <ul>\
            <li><a href="tel:' + SITE.phoneTel + '">' + SITE.phone + '</a></li>\
            <li><a href="contact.html">' + SITE.location + '</a></li>\
          </ul>\
          <p style="font-size:0.72rem;font-weight:700;color:#c0d8c0;text-transform:uppercase;letter-spacing:0.08em;margin:14px 0 6px;">India Office</p>\
          <ul>\
            <li><a href="tel:' + SITE.phoneTelIndia + '">' + SITE.phoneIndia + '</a></li>\
            <li><a href="contact.html">' + SITE.locationIndia + '</a></li>\
          </ul>\
...
function renderContactInfo() {
  ...
  // Phone display text (USA)
  document.querySelectorAll('.site-phone-text').forEach(function(el) {
    el.textContent = SITE.phone;
  });
  // Phone links (India)
  document.querySelectorAll('.site-phone-india-link').forEach(function(el) {
    el.href = 'tel:' + SITE.phoneTelIndia;
  });
  // Phone display text (India)
  document.querySelectorAll('.site-phone-india-text').forEach(function(el) {
    el.textContent = SITE.phoneIndia;
  });
  // Email links
